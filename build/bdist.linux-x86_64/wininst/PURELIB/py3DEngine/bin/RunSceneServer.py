...
import sys, cv2, types, numpy as np, pickle, socket, thread, argparse
...
def keyPressed(*args):
	global scene, infile, outvideofile, outvideo, windowSize, spamreader
...
if __name__ == "__main__":
	...
	parser.add_argument("--server-address", help='Server address (default=127.0.0.1)', default='127.0.0.1')
	...
	s.listen(1)
	thread.start_new_thread(server_handler, (s,))
	#################################################################
