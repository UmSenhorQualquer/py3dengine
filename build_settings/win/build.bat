...
set MAINSCRIPT=%WORKSPACE%\py3dengine\__main__.py
...
pyinstaller --additional-hooks-dir "%BUILDSETTINGSDIR%\hooks" --name "%PROJECTNAME%_v%DEV_VERSION%" --icon "%BUILDSETTINGSDIR%\%ICONNAME%"  "%MAINSCRIPT%"
